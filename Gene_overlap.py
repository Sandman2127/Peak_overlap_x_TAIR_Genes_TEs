...
parser.add_argument('-in', dest='file1',action="store", type=argparse.FileType('r'),help="")
...
Genes=pd.read_table("/Users/mac/Desktop/Github/Gene_and_TE_mapper/TAIR10_genes_only.bed",sep="\t",names=gene_header)
